...
class BaseCollector(ABC):
    EMOTIONAL_INDICATORS = [
        ...
        "fantastic", "horrible", "perfect", "broken", "waste",
        "recommend", "avoid", "regret", "sucks", "great", "bad",
        "excellent", "poor", "beautiful", "ugly", "fast", "slow",
        "easy", "difficult", "worth it", "overpriced", "cheap",
        "expensive", "happy", "sad", "angry", "frustrated",
        "delighted", "disgusted", "pleased", "annoyed", "satisfied",
        "unsatisfied", "issue", "problem", "bug", "crash",
    ]
